          ...
          <div className="lg:pr-8">
            <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
              ...
              <p className="mt-6 text-base font-normal leading-7 text-gray-900">
                HealthNudge is your personalized health companion that combines
                daily wellness tracking, AI-generated insights, and tailored
                diet plans to help you become your healthiest self.
              </p>
              <svg
              ...
              <form action="#" method="post" className="relative mt-4">
                <div className="absolute transitiona-all duration-1000 opacity-30 inset-0 bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] rounded-xl blur-lg filter group-hover:opacity-100 group-hover:duration-200" />
