                ...
                <div className="space-y-10 px-4 md:px-0">
                    <div className="flex items-center justify-center gap-6 max-w-md">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-slate-600">Get instant insights into your live dashboards using AI</p>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-slate-600">End-to-end encryption, Email verification with secure auth</p>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-base font-semibold text-slate-700">Real-Time Analytics</h3>
                            <p className="text-sm text-slate-600">Get instant insights into your medical report with live dashboards</p>
                        </div>
                    </div>
                </div>
            </div>
