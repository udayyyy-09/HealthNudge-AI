        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                size="lg"
                className="bg-black  text-white px-8 py-4 text-lg rounded-3xl cursor-pointer"
              >
                Get Started Today
              </button>
              <button
                size="lg"
                variant="outline"
                className="border-black text-black hover:bg-black hover:text-white px-8 py-4 text-lg bg-transparent rounded-2xl cursor-pointer"
              >
                Learn More
              </button>
            </div>
